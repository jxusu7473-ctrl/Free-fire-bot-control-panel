...
def main():
    ...
    try:
        ...
        # bot.run()
        print("SAMI-V2 Bot is starting safely...")
...
def get_player_info(uid):
    try:
        url = f"https://gojoinfoapi-mu.vercel.app/get?uid={uid}&region=bd"
        res = requests.get(url, timeout=10)
              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[[B][C][9B59B6]╔═══◆ WELCOME TO SAMI BOT ◆═══╗
[7F8C8D]╟──────────────────────────────╢
[FFFFFF]⚡ Powered By : [BB8FCE]Sꫝmi
[FFFFFF]🎯 Status     : [2ECC71]ONLINE All time
[FFFFFF]📱 Contact    : [1ABC9C]tt [b][c]@Sami⚡⚡⚡
[7F8C8D]╟──────────────────────────────╢
...
[FFFFFF]Example: /bundle midnight"""
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "hi", "hello", "commands"):
                            ...
                            basic = """[b][c][1E90FF]🤖   H E L L O WELCOME  T O  SAMI TCP BOT 🤖
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
...
[C][B][FFD700]╰[FF0000]─[FFD700]╯[FFFFFF]
[C][B][FF0000]━━━━━━━━━━━
[C][B][FFFFFF]Username   : [00BFFF]TCP PRO
[C][B][FFFFFF]Signature  : [00BFFF]NONE
